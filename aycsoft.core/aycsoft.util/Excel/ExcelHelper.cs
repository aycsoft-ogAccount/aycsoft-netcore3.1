...
namespace aycsoft.util
{
    ...
    /// 创建人：young
    /// 日 期：2022.09.24
    /// 描 述：NPOI Excel DataTable操作类 application/ms-excel application/vnd-excel
    /// </summary>
    public class ExcelHelper
    {
        ...
        public static MemoryStream ExportMemoryStream(DataTable dtSource, ExcelConfig excelConfig)
        {
            ...
            #region 右击文件 属性信息
            {
                ...
                si.Author = "aycsoft"; //填加xls文件作者信息
                si.ApplicationName = "Aycsoft信息"; //填加xls文件创建程序信息
                si.LastAuthor = "aycsoft"; //填加xls文件最后保存者信息
                si.Comments = "aycsoft"; //填加xls文件作者信息
