...
namespace aycsoft.application
{
    ...
    /// 描 述：桌面图表配置
    /// </summary>
    public class DTChartBLL : BLLBase, DTChartIBLL, BLL
    {
        private readonly DTChartService dTChartService = new DTChartService();
        ...
        {
            await dTChartService.DeleteEntity(keyValue);
        }
        ...
        {
            await dTChartService.SaveEntity(keyValue, entity);
        }
