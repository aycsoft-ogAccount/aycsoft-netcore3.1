...
namespace aycsoft.application
{
    ...
    /// 描 述：流程委托
    /// </summary>
    public class NWFDelegateBLL: BLLBase, NWFDelegateIBLL, BLL 
    {
        ...
        /// <returns></returns>
        public async Task<IEnumerable<NWFDelegateRuleEntity>> GetPageList(Pagination pagination, string keyword)
        {
            var userInfo =await this.CurrentUser();
            return await nWFDelegateService.GetPageList(pagination, keyword, userInfo);
        }
        /// <summary>
        /// 根据委托人获取委托记录
        /// </summary>
        /// <returns></returns>
        public async Task<IEnumerable<NWFDelegateRuleEntity>> GetList()
        {
            var userInfo = await this.CurrentUser();
            return await nWFDelegateService.GetList(userInfo);
        }
        /// <summary>
        /// 获取关联的模板数据
        /// </summary>
        ...
        {
            await nWFDelegateService.DeleteEntity(keyValue);
        }
        /// <summary>
        /// 保存实体
        /// </summary>
        ...
        {
            await nWFDelegateService.SaveEntity(keyValue, wfDelegateRuleEntity, schemeInfoList);
        }
        /// <summary>
        /// 更新委托规则状态信息
        /// </summary>
        ...
        {
            await nWFDelegateService.UpdateState(keyValue, state);
        }
        #endregion
    }
}
