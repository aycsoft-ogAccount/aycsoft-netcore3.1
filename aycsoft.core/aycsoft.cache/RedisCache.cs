...
namespace aycsoft.cache
{
    ...
    public class RedisCache
    {
        ...
        /// </summary>
        /// <param name="dbNum"></param>
        public void FlushDatabase(int dbNum)
        {
            var list = _conn.GetEndPoints();
            foreach (var item in list)
            {
                _conn.GetServer(item).FlushDatabase(dbNum);
            }
        ...
        /// <param name="dbNum"></param>
        /// <returns></returns>
        public async Task FlushDatabaseAsync(int dbNum)
        {
            var list = _conn.GetEndPoints();
            foreach (var item in list)
            {
               await _conn.GetServer(item).FlushDatabaseAsync(dbNum);
            }
