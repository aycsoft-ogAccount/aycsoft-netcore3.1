/*
 * 版 本 Aycsoft-ADMS-Core Aycsoft 敏捷开发框架(http://www.aycsoft.cn)
...
(function ($, aycsoft) {
    ...
    $.extend(aycsoft, {
        ...
        getDate: function (format, strInterval, Number) {
            ...
            var res = aycsoft.formatDate(myDate, format);
            return res;
        },
        // 月
        getMonth:function(){
            ...
            var currentDate = aycsoft.parseDate(aycsoft.formatDate(new Date(), "yyyy-MM-01"));
            var endDate = currentDate.DateAdd('m', 1).DateAdd('d', -1);

            res.begin = aycsoft.formatDate(currentDate, 'yyyy-MM-dd 00:00:00');
            res.end = aycsoft.formatDate(endDate, 'yyyy-MM-dd 23:59:59');
        ...
        getPreMonth: function () {
            ...
            res.begin = aycsoft.formatDate(preMonth, 'yyyy-MM-01 00:00:00');
            res.end = aycsoft.formatDate(preMonth, 'yyyy-MM-dd 23:59:59');
        ...
        getCurrentQuarter: function () {
            ...
            return aycsoft.getQuarter(currentDate.getFullYear(), currentDate.getMonth());
        },
