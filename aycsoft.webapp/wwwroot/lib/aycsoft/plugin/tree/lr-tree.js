...
(function ($, aycsoft) {
    ...
    $.lrtree = {
                    ...
                    if ($this.hasClass('lr-tree-node-expanded')) {
                        ...
                        if (!node.complete) {
                            if (!node._loading) {
                                ...
                                aycsoft.httpAsync('GET', dfop.url, { parentId: node.id }, function (data) {
                                    if (!!data) {
        ...
        search: function (keyword, data) {
            ...
            $.each(data, function (i, row) {
                ...
                if (!aycsoft.validator.isNotNull(keyword).code || row.text.indexOf(keyword) != -1) {
    ...
    $.fn.lrtree = function (settings) {
        ...
        if (dfop.id == null || dfop.id == "") {
            dfop.id = "aycsofttree" + new Date().getTime();
    ...
    $.fn.lrtreeSet = function (name,op) {
        ...
        switch (name) {
            ...
            case 'search':
                ...
                if (aycsoft.validator.isNotNull(op.keyword).code) {
                    dfop._isSearch = true;
                }
