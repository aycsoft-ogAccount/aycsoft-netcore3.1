...
(function ($, aycsoft) {
    ...
    $.fn.lrCustmerFormRender = function (data) {
        ...
        for (var i = 0; i < iLen; i++) {
            ...
            var authorizeField = aycsoft.frameTab.currentIframe().lrForm;//测试表单权限
    ...
    $.lrValidCustmerform = function () {
        ...
        var validHelper = aycsoft.validator;
                ...
                switch (type) {
                    ...
                    case "datepicker":
                        if ($obj.attr('dateformat') == "0") {
                            $obj.val(aycsoft.formatDate(value, 'yyyy-MM-dd'));
                        }
                        else {
                            $obj.val(aycsoft.formatDate(value, 'yyyy-MM-dd hh:mm'));
                        }
